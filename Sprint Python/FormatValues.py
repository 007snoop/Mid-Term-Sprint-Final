...
def FDateS(DateValue):
    ...
    DateValueStr = datetime.datetime.strftime(DateValue, "%Y-%m-%d")
...
def FDateM(DateValue):
    ...
    DateValueStr = datetime.datetime.strftime(DateValue, "%d-%b-%y")
...
def FDateL(DateValue):
    ...
    DateValueStr = datetime.datetime.strftime(DateValue, "%A, %B %d, %Y")
