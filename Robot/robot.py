...
def vision_recognized_marker_number_three(msg):
    ...
    time.sleep(2)
    led_ctrl.set_bottom_led(rm_define.armor_bottom_all, 200, 0, 0, rm_define.effect_marquee)
    led_ctrl.set_top_led(rm_define.armor_top_all, 0, 0, 200, rm_define.effect_marquee)
